...
public interface IBlueprintCreator
{
    ...
    Task<string> CreateNewSubmodelInBlueprintAasAsync(string submodel);
    ...
    Task UpdateSubmodelInBlueprintAasAsync(string submodel, string submodelId);
    ...
    Task DeleteSubmodelInBlueprintAasAsync(string submodelIdBase64Encoded);
}