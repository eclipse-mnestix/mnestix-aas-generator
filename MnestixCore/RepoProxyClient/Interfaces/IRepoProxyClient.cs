...
public interface IRepoProxyClient
{
    ...
    /// <returns>Response content from repository</returns>
    Task<string?> PostAsync(string relativeRepoProxyPath, string jsonContent);
    ...
    /// <returns>Response content from repository</returns>
    Task<string?> PutAsync(string relativeRepoProxyPath, string jsonContent);
    ...
    /// <param name="jsonContent">The content to put as json</param>
    /// <returns>Response content from repository</returns>
    Task<string?> PostSubmodelWithReferenceAsync(string aasIdBase64, string submodelIdNotEncoded, string jsonContent);
    ...
    Task<string?> PutFileContent(string repoProxyPath, string fileName, byte[] fileContent);
    ...
    /// <returns>Response content from repository</returns>
    Task<string?> PatchAsync(string relativeRepoProxyPath, string value);
    ...
    Task<bool> DeleteAsync(string relativeRepoProxyPath);
